...
# Running
## Windows
Using this software is not recommended *or* supported on Windows. Check out the [SM64 PC Info website](sm64pc.info) for a launcher more suited towards your operating system.
## MacOS
